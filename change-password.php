          ...
          <div class="col-md-12 order-md-last d-flex">
            ...
            <form class="bg-white p-5 contact-form" method="post" name="changepassword" onsubmit="return checkpass();">
              ...
              <div class="form-group">
                <label style="font-weight: bolder;">Current Password <span>*</span></label>
                 <input type="password" name="currentpassword" id="currentpassword"  required='true' placeholder="Enter Current Password" class="form-control">
                
              </div>
              <div class="form-group">
                 <label style="font-weight: bolder;">New Password <span>*</span></label>
                <input type="password" name="newpassword" id="newpassword" required='true' placeholder="Enter New Password" class="form-control">
              </div>
              <div class="form-group">
                 <label style="font-weight: bolder;">Confirm Password <span>*</span></label>
              <input type="password" name="confirmpassword" id="confirmpassword" value="" required='true' placeholder="Enter Confirm Password" class="form-control">
              </div>
