            ...
            <form class="bg-white p-5 contact-form" method="post">
             <h3>Forgot Password ?</h3>
              <div class="form-group">
                 <label class="" style="font-weight: bolder;">Email <span>*</span></label>
                 <input type="email" class="form-control" required="true" placeholder="Enter your email" name="email">
              </div>
              <div class="form-group">
                <label class="" style="font-weight: bolder;">Mobile Number <span>*</span></label>
                 <input type="text" class="form-control"  name="mobile"placeholder="Enter your moblie number" required="true" maxlength="10" pattern="[0-9]+">
              </div>
              <div class="form-group">
                  <label class="" style="font-weight: bolder;">New Password <span>*</span></label>
                <input class="form-control" type="password" placeholder="Enter your new password" name="newpassword" required="true"/>
              </div>
            <div class="form-group">
              <label class="" style="font-weight: bolder;">Confirm Password <span>*</span></label>
                 <input class="form-control" type="password" name="confirmpassword" placeholder="Enter your confirm password" required="true"/>
              </div>
